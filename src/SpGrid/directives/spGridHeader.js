    ...
    return {
        ...
        link : function( scope, element, attrs, ctrls, transclude ){
            ...
            function calculateWidth(){
                ...
                var _gapWidth = (_headerWidth - _useageWidth) - ( scope.getScrollbarWidth()  );
                ...
                if( _gapWidth > 0 ){
                    if( _headerWidth > 0 && _headerWidth -1  <=  (sumWidth + scope.getScrollbarWidth()) ) {
                        var overWidth = (sumWidth + scope.getScrollbarWidth()) - (_headerWidth - 8);
